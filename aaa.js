...
function(e) {
  ...
  function g(t) {
    ...
    console[t] = function() {
      ...
      if (k.silentConsole || f(n), "function" == typeof r) if (r.apply) r.apply(console, arguments);
      else {
  ...
  function v(e) {
    return ! k.silentHttp && ((0 !== e.detail.status || !/^file:\/\/\//.test(e.detail.url)) && 2 !== parseInt(e.detail.status / 100))
  }
  function h(t) {
    if (a(w.getAttribute("apikey") || k.apikey) && k.maxEventNumber && !k.silent) {
      k.maxEventNumber -= 1;
      var r = {
        ...
        url: e.location.href,
        title: document.title,
        appVersion: w.getAttribute("appversion") || k.appversion,
        apiKey: w.getAttribute("apikey") || k.apikey,
        releaseStage: w.getAttribute("releasestage") || k.releasestage,
        metaData: t.metaData || k.metaData,
        user: t.user || k.user,
        name: t.name,
        time: (new Date).getTime(),
        message: t.message,
  ...
  var L = "https://fundebug.com/javascript/",
  k = {};
  e.fundebug = k;
  var D = !1,
  w = t();
  k.silent = w.getAttribute("silent") || !1,
  k.maxEventNumber = w.getAttribute("maxEventNumber") || 10,
  k.silentResource = w.getAttribute("silentResource") || !1,
  k.silentHttp = w.getAttribute("silentHttp") || !1,
  k.silentConsole = k.silentConsole || w.getAttribute("silentConsole") || !1,
  r(e, "onerror",
  function() {
  ...
  k.notify = function(e, t, r) {
    if (e) {
      ...
      i = w.getAttribute("apikey") || k.apikey;
  ...
  k.notifyHttpError = function(e, t, r) {
    h({
      type: "httpError",
      req: e,
      res: t,
  ...
  e.onpopstate = function() {
    ...
    if (x.title || (x.title = document.title), x.url !== t.url && d(x, t), R) return R.apply(this, arguments)
  };
  var S = e.history.pushState;
  S && (e.history.pushState = function() {
    x = {
      url: e.location.href,
      title: document.title
    };
    var t = {};
    if (3 === arguments.length && (t.url = arguments[2]), x.url !== t.url && d(x, t), S) return S.apply(this, arguments)
  });
  ...
  e.onhashchange = function() {
    ...
    if (x.url !== t.url && d(x, t), A) return A.apply(this, arguments)
  };
  for (var j = ["log", "warn", "error", "debug", "info"], O = {},
  q = 0; q < j.length; q++) e.console && (O[j[q]] = console[j[q]], k.silentConsole || g(j[q]));
  document.addEventListener && document.addEventListener("DOMContentLoaded",
  function(t) {
    for (var r = 0; r < j.length; r++) e.console && k.silentConsole && O[j[r]] && (console[j[r]] = O[j[r]])
  });
  var C = !1;
  if (e.XMLHttpRequest) {
    ...
    _.send = function() {
      ...
      t.onreadystatechange = function() {
        if (4 === t.readyState && !t.Fundebug && F != L) {
  ...
  if (e.fetch) {
    ...
    e.fetch = function(t, r) {
      ...
      return W.apply(this, arguments).then(function(t) {
  ...
  var $ = "function" == typeof define,
  B = "undefined" != typeof module && module.exports;
  $ ? define(k) : B && (module.exports = k)
} (window);
