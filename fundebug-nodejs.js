module.exports = function(a) {
  ...
  b(b.s = 7)
    ...
    f = {
      ...
      notifierVersion: function(a) {
        try {
          return (!
          function() {
            var a = new Error('Cannot find module "."');
    ...
    f.configure = function(a) {
      a && a && (a.apikey && (f.apikey = a.apikey), a.hasOwnProperty("silent") && (f.silent = a.silent), a.appVersion && (f.appVersion = a.appVersion), a.releaseStage && (f.releaseStage = a.releaseStage), a.user && (f.user = a.user), a.metaData && (f.metaData = a.metaData))
    },
    a.exports = f
  }).call(b, "/")
},
...
function(a, b, c) {
  ...
  g.ExpressErrorHandler = function(a, b, c, d) {
    g.notifyError(a, {
      req: {
        method: b.method,
        ip: b.ip,
  ...
  g.HapiErrorHandler = function(a, b) { (b || 200 !== a.raw.res.statusCode) && (b || (b = {
      name: a.raw.res.statusCode,
      message: a.raw.res.statusMessage
    }), g.notifyError(b, {
      req: {
        method: a.method,
        ip: a.info.remoteAddress,
        protocol: a.connection.info.protocol,
        hostname: a.info.hostname,
        path: a.path,
        port: a.connection.info.port
      },
      res: {
        statusCode: a.raw.res.statusCode,
        statusMessage: a.raw.res.statusMessage
      },
      type: "hapiError"
    }))
  },
